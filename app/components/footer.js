...
export default function Open() {
  return (
    <footer>
      <div
        className="bg-zinc-900 mt-12 text-gray-300 md:ml-20 w-full md:w-[1000px] py-10 px-6 
      ...
      <div className="bg-zinc-800 w-full  pt-10  ">
        <img
          src={
            "https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fshape%2F9.png&w=640&q=75"
          }
        ...
        />
        <p className="md:text-right text-center text-gray-400 mt-6 text-[12px]">
          {" "}
          &copy; Copyrights 2025 Restan. All Rights Reserved.{" "}
        </p>
      </div>
    </footer>
  );
